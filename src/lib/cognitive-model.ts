...
function getFacultyDescription(id: string): string {
  const descriptions: Record<string, string> = {
    ...
    "conceptual-space":
      "Multi-domain geometric model: quality dimensions form domains, convex regions are concepts, points are substances. Similarity = distance; prototype = maximal typicality.",
    memory:
...
export const SENSE_ORGANS: SenseOrgan[] = [
  {
    ...
    angle: 0,
    domainShape: "bicone",
    domainLabel: "Hue · Brightness · Intensity",
  },
  {
    id: "smell",
    label: "Smell",
